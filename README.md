...
| msg    | invalid parameters | service not available temporarily                                                 | invalid identity token                                                                                                        | invalid parameters                                                                                 |
...
| -------- | ------------------------------------------------------------- | ----------------------------------------------------------- |
| 格式要求 | 长度限制为[4, 20]个字符, 只允许<br />大小写字符, 数字和下划线 | 要求[6, 25]的长度限制, 只允<br />许大小写字符, 数字和下划线 |
| 是否必填 | 是                                                            | 是                                                          |
...
| 键名     | password                                                    | password_verify                  | put_type     |
| -------- | ----------------------------------------------------------- | -------------------------------- | ------------ |
| 格式要求 | 要求[6, 25]的长度限制, 只允<br />许大小写字符, 数字和下划线 | 同password, 且要求和password相同 | 填写password |
| 是否必填 | 是                                                          | 是                               | 是           |
